...
class Logger:
    ...
    def setup_wandb(self, log_dir, args):
        ...
        if "sc2_v2" in args.env:
            project_subname = f"{args.env_args['map_name']}_{str(args.env_args['capability_config']['n_units'])}_{str(args.env_args['capability_config']['n_enemeis'])}"
        else:
            project_subname = args.env_args["map_name"]
            
        self.wandb_logger = wandb.init(
            config=args,
            project= args.env + "_" + project_subname,     
